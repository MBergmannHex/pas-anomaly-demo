...
window.chatbotService = {
    ...
    orchestrateReportGeneration: async function ({ report_title, focus_area }) {
        ...
        const analysisPrompt = `
            You are a Senior Alarm Management Consultant writing a formal audit report.
            ...
            Focus on ISA 18.2 compliance risks and the specified focus area: ${focus_area || "General Health"}.
        `;
    ...
    getSystemPrompt: function () {
        return `You are an intelligent industrial alarm assistant helping operators understand and resolve alarm issues.
